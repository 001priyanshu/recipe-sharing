...
const RecipeCard = ({ recipe, fetchRecipes, favoriteRecipes, setFavoriteRecipes }) => {
    ...
    return (
        <div key={recipe._id} className="bg-white p-4 shadow-lg rounded-lg w-11/12 md:w-full"
          >
